...
public class Constants {
    ...
    public static  String STORAGE_SECOND_YEAR_COMPS_Maths = "secondyear/comps/Maths/";
    public static  String STORAGE_SECOND_YEAR_COMPS_Discrete = "secondyear/comps/DiscreteMaths/";
    public static  String STORAGE_SECOND_YEAR_COMPS_DLD = "secondyear/comps/DLD/";
    ...
    public static  String STORAGE_SECOND_YEAR_COMPS_OTHER = "secondyear/comps/OTHER/";

    public static String BLANK_DATABASE = "secondyear/";

    public static  String DATABASE_SECOND_YEAR_COMPS_Maths = "secondyear/comps/Maths/";
    public static  String DATABASE_SECOND_YEAR_COMPS_Discrete = "secondyear/comps/DiscreteMaths/";
    public static  String DATABASE_SECOND_YEAR_COMPS_DLD = "secondyear/comps/DLD/";
    ...
    public static  String DATABASE_SECOND_YEAR_COMPS_OTHER = "secondyear/comps/OTHER/";
}

...
public class Dla extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dla);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                switch (position)
                {
                    case 0: Intent coc = new Intent();
                        ...
                        coc.setData(Uri.parse("https://www.facebook.com/dla.vjti/"));
                        startActivity(coc);
                        break;
                    case 1: Intent coc1 = new Intent();
                        coc1.setAction(Intent.ACTION_VIEW);
                        coc1.addCategory(Intent.CATEGORY_BROWSABLE);
                        coc1.setData(Uri.parse("https://www.instagram.com/dla_vjti/?hl=en"));
                        startActivity(coc1);
                        break;
                }
